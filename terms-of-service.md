...
This Terms of Service Agreement (the "Agreement") is entered into between **Amar** ("Bot Owner") and the user ("User") of the **Amour** Discord bot (the "Bot").

By using **Amour**, the User agrees to be bound by the terms of this Agreement. If the User does not agree to the terms of this Agreement, they should immediately discontinue use of the Bot.
...
8. **Governing Law:** This Agreement shall be governed by and construed in accordance with the laws of **India**. Any dispute arising under or in connection with this Agreement shall be resolved in accordance with applicable Indian law.
